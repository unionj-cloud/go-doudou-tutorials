...
func NewHelloworldClientProxy(client *HelloworldClient, opts ...ProxyOption) *HelloworldClientProxy {
	...
	if cp.runner == nil {
		...
		mid = append(mid, metrics.NewMiddleware("github.com/unionj-cloud/go-doudou-tutorials/grpcdemo/server_client", metrics.NewPrometheusRecorder(prometheus.DefaultRegisterer)))
