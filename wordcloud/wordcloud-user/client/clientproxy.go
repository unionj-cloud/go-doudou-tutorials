...
func (receiver *UsersvcClientProxy) UploadAvatar(ctx context.Context, _headers map[string]string, avatar v3.FileModel) (_resp *resty.Response, data string, err error) {
	if _err := receiver.runner.Run(ctx, func(ctx context.Context) error {
