...
type ComponentaHandlerImpl struct {
	componenta service.Componenta
}

func (receiver *ComponentaHandlerImpl) PostUser(_writer http.ResponseWriter, _req *http.Request) {
	var (
		ctx  context.Context
		user dto.GddUser
		data int32
	...
	data, err = receiver.componenta.PostUser(
		ctx,
		user,
	)
	if err != nil {
...
func (receiver *ComponentaHandlerImpl) GetUser_Id(_writer http.ResponseWriter, _req *http.Request) {
	var (
		ctx  context.Context
		id   int32
		data dto.GddUser
	...
	data, err = receiver.componenta.GetUser_Id(
		ctx,
		id,
	)
	if err != nil {
...
func (receiver *ComponentaHandlerImpl) PutUser(_writer http.ResponseWriter, _req *http.Request) {
	var (
		ctx  context.Context
		user dto.GddUser
		re   error
...
func (receiver *ComponentaHandlerImpl) DeleteUser_Id(_writer http.ResponseWriter, _req *http.Request) {
	var (
		ctx context.Context
		id  int32
		re  error
...
func (receiver *ComponentaHandlerImpl) GetUsers(_writer http.ResponseWriter, _req *http.Request) {
	var (
		ctx              context.Context
