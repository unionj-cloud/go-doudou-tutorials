module go-doudou-tutorials/bistream-client
...
require (
	...
	github.com/unionj-cloud/go-doudou/v2 v2.0.3
	google.golang.org/grpc v1.50.0
	google.golang.org/protobuf v1.28.1
	go-doudou-tutorials/bistream v0.0.0
)
...
replace go-doudou-tutorials/bistream v0.0.0 => ../bistream