...
type ComponentBClientProxy struct {
	client *ComponentBClient
	logger zerolog.Logger
	runner goresilience.Runner
}

func (receiver *ComponentBClientProxy) PostUser(ctx context.Context, _headers map[string]string, user dto.GddUser, options Options) (_resp *resty.Response, data int32, err error) {
...
func (receiver *ComponentBClientProxy) GetUser_Id(ctx context.Context, _headers map[string]string, id int32, options Options) (_resp *resty.Response, data dto.GddUser, err error) {
	if _err := receiver.runner.Run(ctx, func(ctx context.Context) error {
...
func (receiver *ComponentBClientProxy) PutUser(ctx context.Context, _headers map[string]string, user dto.GddUser, options Options) (_resp *resty.Response, re error) {
	if _err := receiver.runner.Run(ctx, func(ctx context.Context) error {
...
func (receiver *ComponentBClientProxy) DeleteUser_Id(ctx context.Context, _headers map[string]string, id int32, options Options) (_resp *resty.Response, re error) {
	if _err := receiver.runner.Run(ctx, func(ctx context.Context) error {
...
func (receiver *ComponentBClientProxy) GetUsers(ctx context.Context, _headers map[string]string, parameter dto.Parameter, options Options) (_resp *resty.Response, data dto.Page, err error) {
	if _err := receiver.runner.Run(ctx, func(ctx context.Context) error {
...
type ProxyOption func(*ComponentBClientProxy)

func WithRunner(runner goresilience.Runner) ProxyOption {
	return func(proxy *ComponentBClientProxy) {
		proxy.runner = runner
	}
}
...
func NewComponentBClientProxy(client *ComponentBClient, opts ...ProxyOption) *ComponentBClientProxy {
	cp := &ComponentBClientProxy{
		client: client,
	...
	if cp.runner == nil {
		...
		mid = append(mid, metrics.NewMiddleware("github.com/wubin1989/microcomponent/component-b_client", metrics.NewPrometheusRecorder(prometheus.DefaultRegisterer)))
