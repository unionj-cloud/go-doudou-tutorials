...
type TestgggormHandler interface {
	PostTInvalidToken(w http.ResponseWriter, r *http.Request)
	PostTInvalidTokens(w http.ResponseWriter, r *http.Request)
	...
	PostTJjjs(w http.ResponseWriter, r *http.Request)
	...
	PostTPosts(w http.ResponseWriter, r *http.Request)
	...
	PostTUsers(w http.ResponseWriter, r *http.Request)
	...
	PostTWordCloudTasks(w http.ResponseWriter, r *http.Request)
	...
	PostTAuthors(w http.ResponseWriter, r *http.Request)
	...
	PostTClients(w http.ResponseWriter, r *http.Request)
	...
	PostTDepts(w http.ResponseWriter, r *http.Request)
	...
	TAuthorPosts(w http.ResponseWriter, r *http.Request)
}

func Routes(handler TestgggormHandler) []rest.Route {
	return []rest.Route{
		{
		...
		{
			Name:        "PostTInvalidTokens",
			Method:      "POST",
			Pattern:     "/t/invalid/tokens",
			HandlerFunc: handler.PostTInvalidTokens,
		},
		{
		...
		},
		{
			...
			Method:      "POST",
			Pattern:     "/t/posts",
			HandlerFunc: handler.PostTPosts,
		},
		{
			Name:        "GetTPost_Id",
			Method:      "GET",
		...
		},
		{
			...
			Method:      "POST",
			Pattern:     "/t/users",
			HandlerFunc: handler.PostTUsers,
		},
		{
			Name:        "GetTUser_Id",
			Method:      "GET",
		...
		{
			Name:        "PostTWordCloudTasks",
			Method:      "POST",
			Pattern:     "/t/word/cloud/tasks",
			HandlerFunc: handler.PostTWordCloudTasks,
		},
		{
		...
		},
		{
			...
			Method:      "POST",
			Pattern:     "/t/authors",
			HandlerFunc: handler.PostTAuthors,
		},
		{
			Name:        "GetTAuthor_Id",
			Method:      "GET",
		...
		},
		{
			...
			Method:      "POST",
			Pattern:     "/t/clients",
			HandlerFunc: handler.PostTClients,
		},
		{
			Name:        "GetTClient_Id",
			Method:      "GET",
		...
		},
		{
			...
			Method:      "POST",
			Pattern:     "/t/depts",
			HandlerFunc: handler.PostTDepts,
		},
		{
			Name:        "GetTDept_Id",
			Method:      "GET",
		...
		},
		{
			Name:        "TAuthorPosts",
			Method:      "POST",
			Pattern:     "/t/author/posts",
			HandlerFunc: handler.TAuthorPosts,
		},
	}
}
