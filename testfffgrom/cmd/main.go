...
func main() {
	...
	svc := service.NewTestfffgrom(conf)
	...
	go func() {
		...
		pb.RegisterTestfffgromServiceServer(grpcServer, svc)
		grpcServer.Run()
	}()

	handler := httpsrv.NewTestfffgromHandler(svc)
