...
func (receiver *ServiceAClient) GetRpcSayHello(ctx context.Context, _headers map[string]string, name string, options Options) (_resp *resty.Response, reply string, err error) {
	var _err error
	_urlValues := url.Values{}
	_req := receiver.client.R()
	if len(_headers) > 0 {
	...
	return _resp, _result.Reply, nil
}
