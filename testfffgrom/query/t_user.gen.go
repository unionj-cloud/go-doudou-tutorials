...
func newTUser(db *gorm.DB, opts ...gormgen.DOOption) tUser {
	_tUser := tUser{}
...
func (t tUser) As(alias string) *tUser {
	t.tUserDo.DO = *(t.tUserDo.As(alias).(*gormgen.DO))
...
func (t tUser) Columns(cols ...field.Expr) gormgen.Columns { return t.tUserDo.Columns(cols...) }
...
type tUserDo struct{ gormgen.DO }
...
type ITUserDo interface {
	...
	Not(conds ...gormgen.Condition) ITUserDo
	Or(conds ...gormgen.Condition) ITUserDo
	Select(conds ...field.Expr) ITUserDo
	Where(conds ...gormgen.Condition) ITUserDo
	...
	Having(conds ...gormgen.Condition) ITUserDo
	Limit(limit int) ITUserDo
	Offset(offset int) ITUserDo
	Count() (count int64, err error)
	Scopes(funcs ...func(gormgen.Dao) gormgen.Dao) ITUserDo
	Unscoped() ITUserDo
	...
	FindInBatch(batchSize int, fc func(tx gormgen.Dao, batch int) error) (results []*model.TUser, err error)
	FindInBatches(result *[]*model.TUser, batchSize int, fc func(tx gormgen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model.TUser) (info gormgen.ResultInfo, err error)
...
func (t tUserDo) Not(conds ...gormgen.Condition) ITUserDo {
	return t.withDO(t.DO.Not(conds...))
}

func (t tUserDo) Or(conds ...gormgen.Condition) ITUserDo {
...
func (t tUserDo) Where(conds ...gormgen.Condition) ITUserDo {
...
func (t tUserDo) Having(conds ...gormgen.Condition) ITUserDo {
...
func (t tUserDo) Scopes(funcs ...func(gormgen.Dao) gormgen.Dao) ITUserDo {
...
func (t tUserDo) FindInBatch(batchSize int, fc func(tx gormgen.Dao, batch int) error) (results []*model.TUser, err error) {
...
func (t tUserDo) FindInBatches(result *[]*model.TUser, batchSize int, fc func(tx gormgen.Dao, batch int) error) error {
...
func (t tUserDo) Delete(models ...*model.TUser) (result gormgen.ResultInfo, err error) {
	return t.DO.Delete(models)
}

func (t *tUserDo) withDO(do gormgen.Dao) *tUserDo {
	t.DO = *do.(*gormgen.DO)
	return t
}
