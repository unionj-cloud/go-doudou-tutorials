...
func newTClient(db *gorm.DB, opts ...gen.DOOption) tClient {
	_tClient := tClient{}
...
func (t tClient) As(alias string) *tClient {
	t.tClientDo.DO = *(t.tClientDo.As(alias).(*gen.DO))
...
func (t tClient) Columns(cols ...field.Expr) gen.Columns { return t.tClientDo.Columns(cols...) }
...
type ITClientDo interface {
	...
	Not(conds ...gen.Condition) ITClientDo
	Or(conds ...gen.Condition) ITClientDo
	Select(conds ...field.Expr) ITClientDo
	Where(conds ...gen.Condition) ITClientDo
	...
	Having(conds ...gen.Condition) ITClientDo
	Limit(limit int) ITClientDo
	Offset(offset int) ITClientDo
	Count() (count int64, err error)
	Scopes(funcs ...func(gen.Dao) gen.Dao) ITClientDo
	Unscoped() ITClientDo
	...
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.TClient, err error)
	FindInBatches(result *[]*model.TClient, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model.TClient) (info gen.ResultInfo, err error)
...
func (t tClientDo) Not(conds ...gen.Condition) ITClientDo {
	return t.withDO(t.DO.Not(conds...))
}

func (t tClientDo) Or(conds ...gen.Condition) ITClientDo {
...
func (t tClientDo) Where(conds ...gen.Condition) ITClientDo {
...
func (t tClientDo) Having(conds ...gen.Condition) ITClientDo {
...
func (t tClientDo) Scopes(funcs ...func(gen.Dao) gen.Dao) ITClientDo {
...
func (t tClientDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.TClient, err error) {
...
func (t tClientDo) FindInBatches(result *[]*model.TClient, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (t tClientDo) Delete(models ...*model.TClient) (result gen.ResultInfo, err error) {
	return t.DO.Delete(models)
}

func (t *tClientDo) withDO(do gen.Dao) *tClientDo {
	t.DO = *do.(*gen.DO)
	return t
}
