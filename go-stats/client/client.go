...
func (receiver *GoStatsClient) LargestRemainder(ctx context.Context, _headers map[string]string, payload vo.PercentageReqVo) (_resp *resty.Response, data []vo.PercentageRespVo, err error) {
	var _err error
