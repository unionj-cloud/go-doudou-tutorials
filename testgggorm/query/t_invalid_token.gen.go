...
func newTInvalidToken(db *gorm.DB, opts ...gormgen.DOOption) tInvalidToken {
...
func (t tInvalidToken) As(alias string) *tInvalidToken {
	t.tInvalidTokenDo.DO = *(t.tInvalidTokenDo.As(alias).(*gormgen.DO))
...
func (t tInvalidToken) Columns(cols ...field.Expr) gormgen.Columns {
...
type tInvalidTokenDo struct{ gormgen.DO }
...
type ITInvalidTokenDo interface {
	...
	Not(conds ...gormgen.Condition) ITInvalidTokenDo
	Or(conds ...gormgen.Condition) ITInvalidTokenDo
	Select(conds ...field.Expr) ITInvalidTokenDo
	Where(conds ...gormgen.Condition) ITInvalidTokenDo
	...
	Having(conds ...gormgen.Condition) ITInvalidTokenDo
	Limit(limit int) ITInvalidTokenDo
	Offset(offset int) ITInvalidTokenDo
	Count() (count int64, err error)
	Scopes(funcs ...func(gormgen.Dao) gormgen.Dao) ITInvalidTokenDo
	...
	FindInBatch(batchSize int, fc func(tx gormgen.Dao, batch int) error) (results []*model.TInvalidToken, err error)
	FindInBatches(result *[]*model.TInvalidToken, batchSize int, fc func(tx gormgen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model.TInvalidToken) (info gormgen.ResultInfo, err error)
...
func (t tInvalidTokenDo) Not(conds ...gormgen.Condition) ITInvalidTokenDo {
	return t.withDO(t.DO.Not(conds...))
}

func (t tInvalidTokenDo) Or(conds ...gormgen.Condition) ITInvalidTokenDo {
...
func (t tInvalidTokenDo) Where(conds ...gormgen.Condition) ITInvalidTokenDo {
...
func (t tInvalidTokenDo) Having(conds ...gormgen.Condition) ITInvalidTokenDo {
...
func (t tInvalidTokenDo) Scopes(funcs ...func(gormgen.Dao) gormgen.Dao) ITInvalidTokenDo {
...
func (t tInvalidTokenDo) FindInBatch(batchSize int, fc func(tx gormgen.Dao, batch int) error) (results []*model.TInvalidToken, err error) {
...
func (t tInvalidTokenDo) FindInBatches(result *[]*model.TInvalidToken, batchSize int, fc func(tx gormgen.Dao, batch int) error) error {
...
func (t tInvalidTokenDo) Delete(models ...*model.TInvalidToken) (result gormgen.ResultInfo, err error) {
	return t.DO.Delete(models)
}

func (t *tInvalidTokenDo) withDO(do gormgen.Dao) *tInvalidTokenDo {
	t.DO = *do.(*gormgen.DO)
	return t
}
