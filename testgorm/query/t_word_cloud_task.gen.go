...
func newTWordCloudTask(db *gorm.DB, opts ...gen.DOOption) tWordCloudTask {
...
func (t tWordCloudTask) As(alias string) *tWordCloudTask {
	t.tWordCloudTaskDo.DO = *(t.tWordCloudTaskDo.As(alias).(*gen.DO))
...
func (t tWordCloudTask) Columns(cols ...field.Expr) gen.Columns {
...
type tWordCloudTaskDo struct{ gen.DO }
...
type ITWordCloudTaskDo interface {
	...
	Not(conds ...gen.Condition) ITWordCloudTaskDo
	Or(conds ...gen.Condition) ITWordCloudTaskDo
	Select(conds ...field.Expr) ITWordCloudTaskDo
	Where(conds ...gen.Condition) ITWordCloudTaskDo
	...
	Having(conds ...gen.Condition) ITWordCloudTaskDo
	Limit(limit int) ITWordCloudTaskDo
	Offset(offset int) ITWordCloudTaskDo
	Count() (count int64, err error)
	Scopes(funcs ...func(gen.Dao) gen.Dao) ITWordCloudTaskDo
	...
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.TWordCloudTask, err error)
	FindInBatches(result *[]*model.TWordCloudTask, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model.TWordCloudTask) (info gen.ResultInfo, err error)
...
func (t tWordCloudTaskDo) Not(conds ...gen.Condition) ITWordCloudTaskDo {
	return t.withDO(t.DO.Not(conds...))
}

func (t tWordCloudTaskDo) Or(conds ...gen.Condition) ITWordCloudTaskDo {
...
func (t tWordCloudTaskDo) Where(conds ...gen.Condition) ITWordCloudTaskDo {
...
func (t tWordCloudTaskDo) Having(conds ...gen.Condition) ITWordCloudTaskDo {
...
func (t tWordCloudTaskDo) Scopes(funcs ...func(gen.Dao) gen.Dao) ITWordCloudTaskDo {
...
func (t tWordCloudTaskDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.TWordCloudTask, err error) {
...
func (t tWordCloudTaskDo) FindInBatches(result *[]*model.TWordCloudTask, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (t tWordCloudTaskDo) Delete(models ...*model.TWordCloudTask) (result gen.ResultInfo, err error) {
	return t.DO.Delete(models)
}

func (t *tWordCloudTaskDo) withDO(do gen.Dao) *tWordCloudTaskDo {
	t.DO = *do.(*gen.DO)
	return t
}
